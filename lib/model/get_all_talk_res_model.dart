...
//
//     final getAllTalkResponseModel = getAllTalkResponseModelFromJson(jsonString);

import 'dart:convert';

GetAllTalkResponseModel getAllTalkResponseModelFromJson(String str) =>
    GetAllTalkResponseModel.fromJson(json.decode(str));

String getAllTalkResponseModelToJson(GetAllTalkResponseModel data) =>
    json.encode(data.toJson());

class GetAllTalkResponseModel {
  List<Talk>? talks;

  GetAllTalkResponseModel({
    this.talks,
  });

  factory GetAllTalkResponseModel.fromJson(Map<String, dynamic> json) =>
      GetAllTalkResponseModel(
        talks: json["talks"] == null
            ? []
            : List<Talk>.from(json["talks"]!.map((x) => Talk.fromJson(x))),
      );
